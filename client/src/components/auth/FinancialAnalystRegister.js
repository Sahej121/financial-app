...
const RegisterContainer = styled.div`
  ...
  &::before {
    ...
    width: 200%;
    height: 200%;
    background: radial-gradient(circle at center, rgba(82, 196, 26, 0.1) 0%, rgba(0,0,0,1) 70%);
    top: -50%;
    left: -50%;
  }
`;
...
const StyledInput = styled(Input)`
  ...
  &:hover, &:focus { border-color: #52c41a !important; background: rgba(255, 255, 255, 0.08) !important; }
`;
...
const StyledInputPassword = styled(Input.Password)`
  ...
  &:hover, &:focus-within { border-color: #52c41a !important; }
`;
...
const StyledSteps = styled(Steps)`
  margin-bottom: 40px;
  .ant-steps-item-process .ant-steps-item-icon { background: #52c41a; border-color: #52c41a; }
  .ant-steps-item-finish .ant-steps-item-icon { border-color: #52c41a; color: #52c41a; }
  .ant-steps-item-finish .ant-steps-item-tail::after { background-color: #52c41a !important; }
            ...
            <StyledCard bordered={false}>
                ...
                <Form form={form} layout="vertical" onFinish={onFinish}>
                    ...
                    <div style={{ marginTop: 32, display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                        ...
                        {currentStep < steps.length - 1 && <StyledButton type="primary" onClick={next} style={{ background: '#52c41a', border: 'none' }}>Next</StyledButton>}
                        {currentStep === steps.length - 1 && <StyledButton type="primary" htmlType="submit" loading={loading} style={{ background: '#52c41a', border: 'none' }}>Complete Registration</StyledButton>}
                    </div>
                </Form>
            </StyledCard>
        </RegisterContainer>
